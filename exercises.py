...
print('Exercise 6:', largest(1, 2, 3))  # Expected output: 3
print('Exercise 6:', largest(10, 4, 2))  # Expected output: 10
print('Exercise 6:', largest(7, 9, 5))  # Expected output: 9
...
print('Exercise 8:', product(3, 10, 2)) 
